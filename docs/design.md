...
| `@company/mfe-agent`          | The shell's connection to the agent over AG-UI: the page's actions as tools, one list of approvals. | core, runtime                    | an adapter, any agent library but `@ag-ui/*`         |
