...
| `@company/mfe-chat`           | The shell's chat client over AG-UI: the page's actions as tools, one list of approvals. | core, runtime                    | an adapter, any agent library but `@ag-ui/*`         |
