...
/**
 * A whole page composed from one design-system component. An MFE does not earn
 * its keep by re-drawing tables; it earns it by owning a routable surface that
 * deploys on its own.
 */
