 ...
 * is the production one; only the session and the network at the far end are replaced. Every
 * adapter's `/testing/mfe-fetch` re-exports this one module.
 */
