 ...
 * test supplies the values. The generated alias is the same whichever adapter a container uses,
 * so every adapter's `/testing/mfe-config` re-exports this one module.
 */
