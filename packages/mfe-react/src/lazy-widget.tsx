 ...
 *
 * Inputs are props and events are `onX` props, so a consumer writes React rather
 * than learning a loading model. `lazyWidget` is called at module scope so the
 * component identity is stable: creating it during render would make React
 * remount the Widget, throwing away its state, on every parent render.
 */
