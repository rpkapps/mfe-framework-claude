...
/**
 * The generated directory is build output, so it stays out of version control, all but the
...
export function gitignoreFile(context: ConfigGenerateContext): GeneratedFile {
  return {
    ...
    contents: [
      `# Generated by ${context.profile.generator}. Everything here is build output, except the`,
      "# developer's own runtime configuration, which the dev server serves and no build ships.",
      '*',
